...
module Chat
  ...
  # Filter (see Chat::DIRECT_LOG_CHAT_GLOBS).  Agent chats live under the
  # job's own files dir (.files/<name>.chat and .files/<name>.society/**).
  # Other jobs' second-order .files trees are excluded by requiring the file
  # to be under THIS job's files dir.
