...
module LLM
  ...
  #
  # The supported/idiomatic way to share backend logic while allowing overrides
  # is to keep the shared implementation as a module, and compose backends by
  # building their singleton-method lookup chain:
  #
  #   class << self
  ...
  module Backend
    ...
    #
    # We now recommend composing backends by manipulating their singleton class
    # directly, but keeping these hooks makes the transition incremental.
